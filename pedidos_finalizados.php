...
<div class="container">
            ...
            if(!isset($_SESSION['admin'])){
                ...
                die("Acceso restringido");
                    ...
                    $lista=consultar_lista2("SELECT * FROM pedidos WHERE pe_entrega = 3 ORDER BY pe_entrega, pe_fechent DESC", array("pe_id", "pe_email", "pe_fechped", "pe_fechent", "pe_totalped", "pe_entrega"), array());
                    $datos="";
                    $datos.="<table class='listapedidos'>";
                    $datos.="<form method='post' action='lista_pedidos.php'>";
                    $datos.="<tr><th>Id</th><th>Email</th><th>Fecha pedido</th><th>Fecha Entrega</th><th>Precio Total</th><th>Estado</th><th><input type='submit' value='Eliminar' name='btn_eliminar'></th></tr>";
