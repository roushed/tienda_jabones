...
<div class="container">
            ...
            if(!isset($_SESSION['admin'])){
                ...
                $lista=consultar_lista2("SELECT * FROM pedidos WHERE pe_entrega = 1 ORDER BY pe_entrega, pe_fechent DESC", array("pe_id", "pe_email", "pe_fechped", "pe_fechent", "pe_totalped", "pe_entrega"), array());
                $datos="";
                        ...
                        if($z != 5){
                            ...
                            switch ($lista[$i][$z]) {
                                ...
                                case "pendiente":
                                    ...
                                    $datos.="<td><input type='button' value='Procesar' onClick=window.location.href='./lista_pedidos.php?estado=2&id=".$lista[$i][0]."'></td>";
                                    
                                    break;
            
                                case "proceso":
                                  
                                    $datos.="<td><input type='button' value='Finalizar Pedido' onClick=window.location.href='./lista_pedidos.php?estado=3&id=".$lista[$i][0]."'></td>";
